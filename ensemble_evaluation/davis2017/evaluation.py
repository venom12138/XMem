...
class DAVISEvaluation(object):
    ...
    def evaluate(self, res_path, metric=('J', 'F'), debug=False):
        ...
        metrics_res = {}
        if 'J' in metric:
            metrics_res['J'] = {"M": [], "R": [], "D": [], "M_per_object": {}, "M_per_frame": {}}
        if 'F' in metric:
            metrics_res['F'] = {"M": [], "R": [], "D": [], "M_per_object": {}, "M_per_frame": {}}
        ...
        for seq in tqdm(list(self.dataset.get_sequences())):
            ...
            for ii in range(all_gt_masks.shape[0]):
                ...
                # print(j_metrics_res[ii])
                # print(np.mean(j_metrics_res[ii]))
                # print('---------')
                if 'J' in metric:
                    ...
                    metrics_res['J']["M_per_frame"][seq_name] = j_metrics_res[ii]
                if 'F' in metric:
                    ...
                    metrics_res['F']["M_per_frame"][seq_name] = f_metrics_res[ii]
