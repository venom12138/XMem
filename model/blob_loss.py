...
# instances, H, W = one_hot_img_wo_bg.shape
# one_hot_img_wo_bg_flatten = one_hot_img_wo_bg.flatten(start_dim=1)
# pixels_sum = torch.sum(one_hot_img_wo_bg_flatten, dim=1)

# for i in range(one_hot_img.shape[0]):
#     if torch.sum(one_hot_img[i]) == 0:
#         one_hot_img[i] = 1
