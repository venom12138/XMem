...
ROOT_PATH = '/u/ryanxli/venom/XMem/EPIC_train'
vid = 'P01_01_37'
use_flow = False 
partition_id = vid.split('_')[0]
video_id = partition_id + '_' + vid.split('_')[1]

ckpt_path = '/u/ryanxli/.exp/0925_state_change_segm/1108_Ablation/D0232_freeze=0,fuse_type=cbam,num_frames=8,steps=1000,use_text=0,use_flow=0/network_10000.pth'
...
# use first mask
mask_name = sorted(glob.glob(f'{ROOT_PATH}/{partition_id}/anno_masks/{video_id}/{vid}/*.png'))[0]
