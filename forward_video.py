...
mask_save_path = './data/P04/forward_masks/P04_01'
draw_save_path = './data/P04/forward_draws/P04_01'
video_path = '/cluster/home2/yjw/venom/XMem/data/P04/positive_frames/P04_01/7991'
# use first mask
mask_name = '/cluster/home2/yjw/venom/EPIC-data/data/P04/first_last_masks/P04_01/7991/frame_0000021224.jpg'
...
for frame_path in sorted(glob.glob(f'{draw_save_path}/{uid}/*.jpg')):
    ...
    images.append(im)
imageio.mimsave(f"/cluster/home2/yjw/venom/EPIC-data/data/P04/forward_gif/{uid}.gif", images, 'GIF', duration=0.05)